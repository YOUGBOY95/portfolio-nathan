...
//#27242f 
   return (
      <Box component={'section'} className={classNames(Style.terminal, Style.shadowed)}
         ...
         <Box sx={{backgroundColor: '#a3a3a3 '}} p={'0.5rem'} borderRadius={'0.5rem 0.5rem 0 0'}
              fontSize={'1rem'}>
         ...
         <Box py={{xs: '1rem', md: '2rem'}} px={{xs: '2rem', md: '3rem'}} borderRadius={'0 0 0.5rem 0.5rem'}
              sx={{backgroundColor: '#3c3943 '}} fontSize={'1.5rem'} fontFamily={'Courier New, Courier, monospace'}>
            {text}
         </Box>
      </Box>
   );
